...
* [1. JavaScript Modules](javascript-modules.md#1-javascript-modules)
  * [1.1. Lesson Objectives](javascript-modules.md#11-lesson-objectives)
  * [1.2. Overview](javascript-modules.md#12-overview)
  * [1.3. Creating a Module](javascript-modules.md#13-creating-a-module)
    * [1.3.1. Private Methods](javascript-modules.md#131-private-methods)
    * [1.3.2. Public Methods](javascript-modules.md#132-public-methods)
    * [1.3.3. Namespacing](javascript-modules.md#133-namespacing)
  * [1.4. The Revealing Module Pattern](javascript-modules.md#14-the-revealing-module-pattern)
  * [1.5. The Singleton Pattern](javascript-modules.md#15-the-singleton-pattern)
    * [1.5.1. Singleton as IIFE](javascript-modules.md#151-singleton-as-iife)
    * [1.5.2. Singleton with Lazy Initialization](javascript-modules.md#152-singleton-with-lazy-initialization)
  * [1.6. Resources](javascript-modules.md#16-resources)
